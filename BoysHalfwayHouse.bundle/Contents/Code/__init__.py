...
PLUGIN_LOG_TITLE = 'BoysHalfwayHouse'
LOG_BIGLINE = '------------------------------------------------------------------------------'
LOG_SUBLINE = '      ------------------------------------------------------------------------'
...
CROPPER = r'CScript.exe "{0}/Plex Media Server/Plug-ins/BoysHalfwayHouse.bundle/Contents/Code/ImageCropper.vbs" "{1}" "{2}" "{3}" "{4}"'
...
XML_PATHS = {
        ...
        'SearchTitle': '//h3/text()',
        'SearchUrl': './@href',
        'SiteTitle': '//div[@class="sceneTitle"]/text()',
        'SiteSummary': '//div[@class="sceneDescription"]', #not the text but the XML element
        'ReleaseDate' : '',
        'SiteArts': '//div[@class="sceneSectWrapper"]//img[@class="imgSceneMedium"]/@src',
        'CastMembers': '//div[@class="scenePerformers"]/a',
        'CastMembersName': '//div[@class="scenePerformers"]/a/text()[normalize-space()]',
        'CastName': './text()',
        'CastUrl': './@href',
        'CastPhoto': '//div[@class="profImages"]/img/@src',
        'SiteTags': '//div[@class="sceneTags"]//a[@class="sceneTagsLnk"]/text()',
        'Studio': ''
}

# URLS
BASE_URL = 'https://www.boyshalfwayhouse.com/'
BASE_SEARCH_URL = 'https://www.google.com/search?q=site%3Aboyshalfwayhouse.com+{0}'
BASE_VIDEO = 'https://www.boyshalfwayhouse.com/scene/{0}'
...
# ----------------------------------------------------------------------------------------------------------------------------------
class BoysHalfwayHouse(Agent.Movies):
    ''' define Agent class '''
    name = 'BoysHalfwayHouse (IAFD)'
