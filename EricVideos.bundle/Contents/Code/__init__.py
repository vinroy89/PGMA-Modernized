...
XML_PATHS = {
        ...
        'SearchTitle': '//h3/text()',
        'SearchUrl': './@href',
        'SiteTitle': '//h1[@class="vod_liste_video_titre"]/text()',
        'SiteSummary': '//div[@class="video-info"]/div[@class="texte"]',
        'ReleaseDate' : '',
        'SiteArts': '//div[@class="vod_screenshots"]/div/a/img/@src',
        'CastMembers': '//div[@class="acteurs"]/ul/li',
        'CastMembersName': '//div[@class="acteur"]/div[@class="nom"]/text()[normalize-space()]',
        'CastName': './/div[@class="nom"]/text()[normalize-space()]',
        'CastUrl': './/a/@href',
        'CastPhoto': '//div[@class="photo_acteur"]/img/@src',
        'SiteTags': '//div[@class="categories"]/ul/li/a/text()',
        'Studio': ''
}

# URLS
BASE_URL = 'https://www.ericvideos.com'
BASE_SEARCH_URL = 'https://www.google.com/search?q=site%3Aericvideos.com+{0}'
BASE_VIDEO = 'https://www.ericvideos.com/EN/vod/1/{0}'
...
def Start():
    ...
    HTTP.Headers['Cookie'] = 'warning=1; trailerViews=1;lang=EN;locale=en_US' #Bypasses the age verification screen
# ----------------------------------------------------------------------------------------------------------------------------------
def ValidatePrefs():
...
import utilsGenres
# ----------------------------------------------------------------------------------------------------------------------------------
class EricVideos(Agent.Movies):
    ''' define Agent class '''
    name = 'EricVideos (IAFD)'
    ...
    def CleanSearchString(self, myString):
        ...
        # EricVideos seems to fail to find Titles which have invalid chars in them, split at first incident and take first split, just to search but not compare
    ...
    def update(self, metadata, media, lang, force=True):
        ...
        # Process Genres
        log(LOG_SUBLINE)
        genres = utilsGenres.getGenres(genreList)
        ...
        # synopsis
        #IAFD data is in french, so were pulling the synopsis from Eric's site
        synopsis = ''
        try:
