...
CROPPER = r'CScript.exe "{0}/Plex Media Server/Plug-ins/EricVideos.bundle/Contents/Code/ImageCropper.vbs" "{1}" "{2}" "{3}" "{4}"'
THUMBOR = Prefs['thumbor'] + "/0x0:{0}x{1}/{2}"

XML_PATHS = {
        'Search': '//div[@class="shoot-return"][1]/div[contains(@class,"scene")]/descendant::a[@class="shoot-link"]',
        'SearchTitle': './img[1]/@alt',
        'SearchUrl': './@href',
        'SiteTitle': '//meta[@name="twitter:title"]/@content',
        'SiteSummary': '//span[@class="description-text"][1]/p[1]',
        'ReleaseDate' : '//p/span[@class="shoot-date"]/text()',
        'SiteArts': '//div[@id="gallerySlider"]/a/img[@class="gallery-img"]/@data-image-file',
        'CastMembers': '//p[@class="starring"]/span[contains(@class,"names")]/a',
        'CastMembersName': '//p[@class="starring"]/span[contains(@class,"names")]/a/text()',
        'CastName': './text()',
        'CastUrl': './@href',
        'CastPhoto': '//*[@class="bio-img" or @class="bio-slider-img"]/@src',
        'SiteTags': '//p[contains(@class,"category-tag-list")]/a[@class="tag"]/text()',
        'Studio': '//div[contains(@class,"shoot-page")]/@data-sitename'
}
STUDIO = ["BoundInPublic", "BoundGods", "MenOnEdge", "KinkyBites", "30minutesoftorment", "ButtMachineBoys", "KinkMenClassics", "MenAtPlay", "Men At Play"]
# URLS
BASE_URL = 'https://www.kink.com'
BASE_SEARCH_URL = 'https://www.kink.com/search?type=shoots&q={0}'
BASE_VIDEO = 'https://www.kink.com/shoot/{0}'
...
def Start():
    ...
    HTTP.Headers['referrer'] = 'https://rawfuckclub.com'
# ----------------------------------------------------------------------------------------------------------------------------------
def ValidatePrefs():
